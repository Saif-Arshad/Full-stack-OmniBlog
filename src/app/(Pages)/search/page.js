                ...
                {data.slice(0, load).map((blog) => (
                  <div key={blog._id} className='main-card'>
                    ...
                    <div className='p-5'>
                      ...
                      <Link href={`/blog/${blog._id}`}>
                        <h5 className='mb-2 text-lg sm:text-xl dark:hover:text-blue-500  hover:text-blue-500 hover:underline capitalize font-semibold mt-4 tracking-tight text-gray-900 dark:text-white'>
                          {blog.title}
                        </h5>
                      </Link>
                      <Link href={`/blog/${blog._id}`}>
