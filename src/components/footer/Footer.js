  ...
  return (
      <footer>
        <div className="bg-white py-4 mt-9 text-black shadow-2xl">
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-purple-700">Latest Blog</h2>
            </div>
            <ul className="leading-8">
              <li><Link href="#" className="hover:text-purple-700">Getting Started With HTML and CSS</Link></li>
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-purple-700">Connect With Us</h2>
            </div>
            <Link href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-purple-700 hover:border-purple-700">
            ...
            <Link href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-purple-700 hover:border-purple-700">
        ...
        <div className="bg-gray-500 py-4 text-gray-100">
