      ...
      <footer>
        <div className="bg-white py-4 text-black dark:bg-slate-900 dark:text-gray-200 shadow-2xl">
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <Link href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-purple-700 dark:hover:text-blue-400 hover:border-purple-700 dark:hover:border-blue-700">
            ...
            <Link href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-purple-700 dark:hover:text-blue-400 hover:border-purple-700 dark:hover:border-blue-700">
